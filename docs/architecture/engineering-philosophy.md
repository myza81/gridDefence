...
*Implementation note: this engineering question is answered by the Automatic Load Shedding Functionality Registry (ADR-011), which realizes what this document calls the Relay Registry — see [02-engineering-concepts.md](../engineering/02-engineering-concepts.md)'s Relay Registry entry and [EDR-003](../engineering/edr/EDR-003-relay-registry-scope.md) for the scope decision this step's philosophy is built on.*
